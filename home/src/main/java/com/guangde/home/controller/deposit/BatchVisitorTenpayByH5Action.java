...
public class BatchVisitorTenpayByH5Action extends DepositBaseAction {
	...
	// 服务器异步通知页面路径
	public static final String notify_url = "https://www.17xs.org/visitorAlipay/async.do";
	// 页面跳转同步通知页面路径
	public static final String return_url = "https://www.17xs.org/visitorAlipay/return_url.do";
		...
		if(browser.equals("wx")){
			...
			if (rt != null && rt.getCode() == 1) {
				...
				try {
						...
						tpWxPay1.setNotifyUrl("https://www.17xs.org/batchpay/tenpay/asyncresult/"+tpWxPay1.getOrderId()+"/");
