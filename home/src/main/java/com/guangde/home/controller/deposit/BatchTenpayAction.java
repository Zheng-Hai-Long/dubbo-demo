...
public class BatchTenpayAction extends DepositBaseAction {
	...
	// 服务器异步通知页面路径
	public static final String notify_url = "https://www.17xs.org/batchpay/tenpay/async.do";
	// 页面跳转同步通知页面路径
	public static final String return_url = "https://www.17xs.org/batchpay/tenpay/return_url.do";
	//二维码的底版
