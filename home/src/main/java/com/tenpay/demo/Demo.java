...
public class Demo {
	...
	private static String appid = "wx0a315b7a1eb22add";
	private static String appsecret = "a7278a50c7a30183d92f3b3fba441a84";
	...
	public static void main(String[] args) {
		...
		String msg = getCodeurlPublic(wxPayDto,null);
	 ...
	 * 获取微信扫码支付二维码连接
	 */
	public static String getH5WeixinPayurl(WxPayDto tpWxPayDto){
		...
		System.out.println("setxml"+xml);
		mweb_url = GetWxOrderno.getMWebUrl(createOrderURL, xml);
