...
public class ApiServiceLeaveWord extends BaseBean implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 2536847208812132691L;
	private Integer id;
	/**
	 * 主题id
	 */
	 ...
	 * 图片
	 */
	private List<ApiBFile> bfList = new ArrayList<ApiBFile>();
	/**
	 * 头像id
	 */
	...
	public List<ApiBFile> getBfList() {
		return bfList;
	}
	public void setBfList(List<ApiBFile> bfList) {
		this.bfList = bfList;
	}
	...
	public String toString() {
		return "ApiServiceLeaveWord [id=" + id + ", serviceId=" + serviceId
