...
public class ApiPayMoneyRecord extends BaseBean implements Serializable
{
    
    /**
	 * 
	 */
	private static final long serialVersionUID = -628480829083667712L;
    ...
    {
        return "ApiPayMoneyRecord [account=" + account + ", applyMoney=" + applyMoney + ", capitalinoutId=" + capitalinoutId + ", createTime=" + createTime + ", id=" + id + ", operator=" + operator
            + ", panMoney=" + panMoney + ", payMoneyTime=" + payMoneyTime + ", payNum=" + payNum + ", payType=" + payType + ", projectId=" + projectId + ", projectTitle=" + projectTitle+", field=" + field +
             ", receiptImageId=" + receiptImageId + ", receiptImageIdUrl=" + receiptImageIdUrl + ", recipientBankType=" + recipientBankType + ", recipientName=" + recipientName + ", source="
            + source + ", state=" + state + ", tranNum=" + tranNum + ", userId=" + userId + "]";
    }
