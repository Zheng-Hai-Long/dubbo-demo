...
public class PageInterceptor implements Interceptor {
        ...
        if (mappedStatement.getId().matches(pageSqlId)) {
            ...
            if (parameterObject == null) {
            	...
            	try {
            		...
            		throw new NullPointerException(mappedStatement.getId() + " parameterObject[\"page\"] is null!");
				}
            }
        }
        // 将执行权交给下一个拦截器
    ...
    private void setPageParameter(String sql, Connection connection, MappedStatement mappedStatement,
        ...
        try {
            ...
            int totalPage = totalRecord / page.getPageSize() + ((totalRecord % page.getPageSize() == 0) ? 0 : 1);
    ...
    public StringBuilder buildPageSqlForMysql(String sql, Page page) {
        ...
        pageSql.append(sql);
        if (page.getSortType() != 0) {
        	pageSql.append(" order by ").append(page.getSortValue()).append(page.getSortType() < 0 ? "desc" : "asc");
        }
