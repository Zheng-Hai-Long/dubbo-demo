...
public enum ResultCode
{
    ...
    illegalError(10002, "包含非法字符"), tooManyCard(10003, "银行卡超限制"), hasBingding(10004, "银行卡已绑定"), companyExist(10005, "该企业已发起过认证"), companyNoExist(10006, "企业不存在"),
    ...
    drawMoney_not_found(90005, "找不到提款记录"), CompanyGoodHelp_not_found(90006, "找不企业助善记录"), project_is_end(90007, "项目募捐已结束"), goodHelpProject_is_stop(90008, "企业助善已终止"), goodHelpProject_is_full(90009,
        "企业助善已满"), goodHelpProjectExist(90010, "企业对此项目已发起过助善"), goodPassWordNoCompanyExist(90011, "口令对应的公司不存在"), goodHelpProjectNoCompanyExist(90012, "助善项目对应的公司不存在"), projectAndGoodPassWordError(
        90013, "助善项目跟口令对应的公司不一致"), drawMoneyNoEnd(90014, "有一笔未完结的项目提款存在"),
    ...
    ParameterError(-1, "参数错误"), UserNotExist(-2, "用户不存在"), WrongPassword(-3, "密码错误"), Disable(-101, "此用户已停用"), Pause(-102, "此用户已暂停"), Lock(-103, "此用户已锁定"), UserExist(-4, "用户名已经存在"), SystemError(-5,
        "系统错误"), FileNotExist(-6, "文件不存在"),ThirdUserExist(-7, "第三方用户已经存在"),
    redpay_pool_status(80001, "红包状态不对"), redpay_pool_endtime(80002, "红包有效期到了"), redpay_project_stop(80003, "红包项目结束"),redpay_pool_used(80004, "红包已使用");
