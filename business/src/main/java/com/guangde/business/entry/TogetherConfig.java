...
public class TogetherConfig  extends BaseBean  implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -7788878172546646977L;
	private Integer id;
	...
	public String toString() {
		return "TogetherConfig [id=" + id + ", type=" + type + ", projectId="
				+ projectId + ", launchName=" + launchName + ", userId="
				+ userId + ", totalMoney=" + totalMoney + ", content="
				+ content + ", click=" + click + ", donateMoney=" + donateMoney
				+ ", totalDonateMoney=" + totalDonateMoney + ", donateNum="
				+ donateNum + ", totalDonateNum=" + totalDonateNum
				+ ", totalFaqiNum=" + totalFaqiNum + ", coverImageId="
				+ coverImageId + ", createTime=" + createTime + ", updateTime="
				+ updateTime + ", coverImageUrl=" + coverImageUrl
				+ ", shareState=" + shareState + ", nickName=" + nickName
				+ ", nameOpen=" + nameOpen + ", teamPlayNum=" + teamPlayNum
