...
public class ProductOrder extends BaseBean implements Serializable{
	...
	private ProductShipment shipment;
	...
	public ProductShipment getShipment() {
		return shipment;
	}

	public void setShipment(ProductShipment shipment) {
	...
	public String toString() {
		return "ProductOrder [id=" + id + ", userId=" + userId + ", tranNum="
				+ tranNum + ", productId=" + productId + ", productName="
				+ productName + ", price=" + price + ", amountMoney="
				+ amountMoney + ", stockNum=" + stockNum + ", state=" + state
				+ ", leaveWord=" + leaveWord + ", createTime=" + createTime
				+ ", updateTime=" + updateTime + ", shipmentNum=" + shipmentNum
				+ ", shipment=" + shipment + ", productSpecificationName="
				+ productSpecificationName + ", coverImageId=" + coverImageId
