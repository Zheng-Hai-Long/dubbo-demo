...
public class ProjectFeedback extends BaseBean implements Serializable  
{
    ...
    private List<LeaveWord> leaveWordList = new ArrayList<LeaveWord>();
    ...
    private List<NewLeaveWord> newLeaveWordList;

    public List<NewLeaveWord> getNewLeaveWordList() {
        return newLeaveWordList;
    }

    public void setNewLeaveWordList(List<NewLeaveWord> newLeaveWordList) {
        this.newLeaveWordList = newLeaveWordList;
    }
	...
	public String toString() {
		return "ProjectFeedback [id=" + id + ", projectId=" + projectId
				...
				+ ", leaveWordList=" + leaveWordList + ", activityId="
