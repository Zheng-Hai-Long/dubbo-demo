...
public class DonateRecord extends BaseBean implements Serializable
{
    ...
    private List<NewLeaveWord> apiNewLeaveWordList;
    ...
    public List<NewLeaveWord> getApiNewLeaveWordList() {
        return apiNewLeaveWordList;
    }

    public void setApiNewLeaveWordList(List<NewLeaveWord> apiNewLeaveWordList) {
	...
	public String toString() {
		return "DonateRecord [id=" + id + ", userId=" + userId
